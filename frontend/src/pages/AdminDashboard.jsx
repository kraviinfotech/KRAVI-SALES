    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
          ...
          <button className="text-sm font-bold text-indigo-600 hover:text-indigo-700">View All Managers</button>
        </div>
        <div className="p-12 text-center">
          ...
          <button className="mt-6 bg-slate-900 text-white px-6 py-2 rounded-lg font-bold text-sm hover:bg-slate-800 transition-all">
