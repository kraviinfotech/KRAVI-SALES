      ...
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-black text-slate-950">Complete your subscription</h1>
          ...
          <div className="mt-8 space-y-5">
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-5">
              <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                <div>
                  <h2 className="text-xl font-black text-slate-950">{selectedPlan.name}</h2>
                  <p className="text-sm text-slate-500">{selectedPlan.description || 'SalesFlow subscription plan'}</p>
                </div>
                <div className="text-left sm:text-right">
                  <p className="text-3xl font-black text-slate-950">Rs. {Number(selectedPlan.price || 0).toLocaleString('en-IN')}</p>
